...
function createControls()
{
    ...
    const locLatControl = locationFolder.add(guiControls, 'locationLat', -90, 90, 0.01).onChange(requestFrame);
    const locLonControl = locationFolder.add(guiControls, 'locationLon', -180, 180, 0.01).onChange(requestFrame);
    ...
    displayFolder.add(guiControls, 'lockLonRot').onChange(requestFrame());
    displayFolder.add(guiControls, 'lockLatRot').onChange(requestFrame());
